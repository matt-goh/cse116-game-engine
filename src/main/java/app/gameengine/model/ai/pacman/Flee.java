...
public class Flee extends Decision {
    ...
    /**
     * Constructs a Flee decision for the given ghost.
     *
    ...
    /**
     * Returns true if the ghost is in Frightened state.
     *
     * @param dt    the time delta
     * @param level the current level
     * @return true if ghost state is "Frightened"
     */
    @Override
    ...
    /**
     * Performs flee behavior - moves in random valid directions.
     * Uses getRandomDirection() to choose direction randomly.
     *
     * @param dt    the time delta
     * @param level the current level
     */
